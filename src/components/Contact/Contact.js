...
const Contact = () => {
    ...
    const onSubmit = (e) => {
        ...
        if (contactDates.name === "" ||
            ...
            emailjs.sendForm(
                process.env.REACT_APP_EMAILJS_SERVICE_ID,// 'service_tu4xqss',//AQUí va su ID DE SERVICIO EMAILJS
                process.env.REACT_APP_EMAILJS_TEMPLATE_ID,// 'template_cmzf7sm',//AQUÍ VA EL TEMPLATE ID
                form.current,
                process.env.REACT_APP_EMAILJS_PUBLIC_USER_ID// 'fxhZBOaHsRjcUv94j'//AQUÍ VA LA PUBLIC KEY
            ).then(
                (result) => {
